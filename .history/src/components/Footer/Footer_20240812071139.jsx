import country from '../../assets/images/icons/16.png'
function Footer() {
  return (
    <>
		...
		<div className="container"> 
			...
			<div className="footer-links-wrapper row"> 
				<div className="links-wrapper-1 col-sm-12 col-md">
					<h3 className='Link1'>Shop and Learn</h3>
					<ul>
						<li><a href="#">Mac</a></li>
						<li><a href="#">iPad</a></li>
			...
			<div className="copyright-wrapper row">
				...
				<div className="footer-country  col-sm-12 order-1 col-md-4 order-md-2 text-md-right col-lg-2 order-lg-3">
					<div className="flag-wrapper"><img src={country}/></div> <div className="footer-country-name">United States</div> 
				</div>
			</div>
		</div>
	</footer> 
